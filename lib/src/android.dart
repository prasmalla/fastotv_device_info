...
const mtkAsano32LH7010T = AndroidDeviceWithoutTouch(
    ...
    model: "32LH7010T",
    landscape: MediaQueryData(
        padding: EdgeInsets.zero, size: Size(1280, 720), devicePixelRatio: 1.5),
    portrait: MediaQueryData(
...
const AmazonFireTVStick = AndroidDevice(
    ...
    landscape: const MediaQueryData(
        padding: EdgeInsets.zero, size: Size(960, 540), devicePixelRatio: 2.0),
...
const rockchipTX2 = AndroidDeviceWithoutTouch(
    ...
    model: "TX2",
    landscape: MediaQueryData(
        padding: EdgeInsets.zero, size: Size(1280, 720), devicePixelRatio: 1.0),
    portrait: MediaQueryData(
        padding: EdgeInsets.zero,
        size: Size(720, 1280),
